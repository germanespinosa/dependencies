...
macro (install_git_dependency DEPENDENCY_REPOSITORY)
    cmake_parse_arguments(DEPENDENCY
            "AUTO_UPDATE;CONNECTED;NO_BUILD;VERBOSE;ADD_SUBDIRECTORY;DOWNLOAD_ONLY;CMAKE_PROJECT"
            "BRANCH;TAG;TARGET"
    ...
    if(${DEPENDENCY_HAS_INCLUDE_DIRECTORIES})
        foreach(DEPENDENCY_INCLUDE_DIRECTORY ${DEPENDENCY_INCLUDE_DIRECTORIES})
            if("${DEPENDENCY_TARGET}" STREQUAL "")
                ...
                target_include_directories(${DEPENDENCY_TARGET} ${DEPENDENCY_FOLDER}/${DEPENDENCY_TARGET_INCLUDE_DIRECTORY})
            endif()
        endforeach()
    endif()
endmacro()
